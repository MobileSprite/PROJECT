//
//  UILabel+DatePickerLabel.m
//  提醒精灵1.0
//
//  Created by Mr.Alien on 15/9/11.
//  Copyright (c) 2015年 wrcj. All rights reserved.
//

#import "UILabel+DatePickerLabel.h"
#import <objc/runtime.h>

@implementation UILabel (DatePickerLabel)
...
-(void) swizzledSetTextColor:(UIColor *)textColor {
    if([self view:self hasSuperviewOfClass:[UIDatePicker class]] ||   [self view:self hasSuperviewOfClass:NSClassFromString(@"UIDatePickerWeekMonthDayView")] ||
